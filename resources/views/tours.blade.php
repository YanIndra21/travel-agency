...
<div class="w-full h-56 opacity-85 md:h-96 overflow-hidden flex justify-center items-center">
  <h1 class="z-[999] text-4xl text-center lg:!text-8xl  capitalize  absolute text-white font-caveat">Tours</h1>
  <img src="/img/kelingking.jpg" class="lg:object-cover" alt="Nusa Penida">
</div>
{{-- picture header end --}}
